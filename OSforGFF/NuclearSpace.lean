...
@[blueprint "def:nuclear-space"
  (title := "Nuclear Space")
  (statement := /-- A \textbf{nuclear space} is a locally convex space whose topology is generated by a countable family of Hilbertian seminorms with Hilbert-Schmidt inclusion maps. -/)
  (latexEnv := "definition")
  (latexLabel := "def:nuclear-space")
  (misc := "Treves, Topological Vector Spaces, Ch. 50-51; Gelfand-Vilenkin Vol. 4, Ch. 3-4")]
